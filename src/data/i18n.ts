...
export const ui: Record<Locale, any> = {
  en: {
    ...
    hero: {
      title: "Louvre Museum Tickets with E-Guide",
  ...
  fr: {
    ...
    hero: {
      title: "Billets pour le musée du Louvre avec e-guide",
...
ui.es = {
  ...
  hero: { title: "Entradas para el Museo del Louvre con e-guide", lede: "Reserve su entrada al Louvre con nuestra e-guide digital — su conserjería de entradas en París.", badges: ["⚡ Confirmación rápida", "⚡ Evita la caja", "📱 Entradas móviles", "🎧 Soporte 08:00-22:00"], select: "1. Elija su tipo de entrada abajo", from: "Desde", selectCta: "Reservar", bestSeller: "Más vendido" },
...
ui.de = {
  ...
  hero: { title: "Louvre Museum Tickets mit E-Guide", lede: "Reservieren Sie Ihren Louvre-Eintritt mit unserem digitalen E-Guide — Ihr Ticket-Concierge in Paris.", badges: ["⚡ Schnelle Bestätigung", "⚡ Museumskasse vermeiden", "📱 Mobile Tickets", "🎧 Support 08:00-22:00"], select: "1. Wählen Sie unten Ihren Tickettyp", from: "Ab", selectCta: "Jetzt buchen", bestSeller: "Bestseller" },
...
ui.it = {
  ...
  hero: { title: "Biglietti per il Museo del Louvre con e-guide", lede: "Prenota il tuo ingresso al Louvre con la nostra e-guide digitale — il tuo concierge dei biglietti a Parigi.", badges: ["⚡ Conferma rapida", "⚡ Evita la cassa", "📱 Biglietti mobili", "🎧 Supporto 08:00-22:00"], select: "1. Scegli il tipo di biglietto qui sotto", from: "Da", selectCta: "Prenota ora", bestSeller: "Più venduto" },
